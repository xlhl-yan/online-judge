package com.xlhl.onlinejudgequestionservice.controller;


import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.gson.Gson;
import com.xlhl.onlinejudgecommon.annotation.AuthCheck;
import com.xlhl.onlinejudgecommon.common.BaseResponse;
import com.xlhl.onlinejudgecommon.common.DeleteRequest;
import com.xlhl.onlinejudgecommon.common.ErrorCode;
import com.xlhl.onlinejudgecommon.common.ResultUtils;
import com.xlhl.onlinejudgecommon.constant.UserConstant;
import com.xlhl.onlinejudgecommon.exception.BusinessException;
import com.xlhl.onlinejudgecommon.exception.ThrowUtils;
import com.xlhl.onlinejudgemodel.model.dto.question.*;
...
import com.xlhl.onlinejudgemodel.model.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Long> addQuestion(@RequestBody QuestionAddRequest questionAddRequest, HttpServletRequest request) {
        ...
        if (judgeConfig != null) {
            String judgeConfigStr = JSONUtil.toJsonStr(judgeConfig);
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        User loginUser = userFeignClient.getLoginUser(request);
        //  非本人和管理员不可访问
        if (!Objects.equals(question.getUserId(), loginUser.getId()) &&
                !Objects.equals(loginUser.getUserRole(), UserConstant.ADMIN_ROLE)) {
