...
import com.xlhl.onlinejudge.judge.JudgeService;
import com.xlhl.onlinejudge.mapper.QuestionSubmitMapper;
...
public class QuestionSubmitServiceImpl extends ServiceImpl<QuestionSubmitMapper, QuestionSubmit>
    ...
    public QuestionSubmitVO getQuestionSubmitVO(QuestionSubmit questionSubmit, User loginUser) {
        ...
        if (!Objects.equals(questionSubmitVO.getUserId(), loginUser.getId()) && userService.isAdmin(loginUser)) {
            //  数据脱敏
