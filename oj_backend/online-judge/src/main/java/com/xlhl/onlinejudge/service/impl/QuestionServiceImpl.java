...
import com.xlhl.onlinejudge.mapper.QuestionMapper;
import com.xlhl.onlinejudge.model.dto.question.QuestionQueryRequest;
import com.xlhl.onlinejudge.model.entity.Question;
import com.xlhl.onlinejudge.model.entity.User;
import com.xlhl.onlinejudge.model.vo.QuestionVO;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if (StringUtils.isNotBlank(judgeCase) && judgeCase.length() > 8192) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "用例过多");
        }
